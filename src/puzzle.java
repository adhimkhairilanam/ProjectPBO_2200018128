...
//mengatur kotak kotak
        ...
        solu = new JLabel("Adhim Khairil Anam");
    ...
    private BufferedImage loadImage() throws IOException {
        ...
        BufferedImage bimg = ImageIO.read(new File("Gambar/gambarpuzzle/miku.png"));
    ...
    private void checkSolution() {
        ...
        if (compareList(solution, current)) {
            JOptionPane.showMessageDialog(panel, "MANTAP",
